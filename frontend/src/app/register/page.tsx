        ...
        <div className="relative z-10 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4 pt-8">
            <div className="group bg-white/10 backdrop-blur-sm rounded-2xl p-4 border-2 border-white/20 hover:bg-white/20 transition-all cursor-pointer hover:scale-105">
              <div className="text-3xl font-bold text-white mb-1 group-hover:scale-110 transition-transform">Smart</div>
              <div className="text-white/80">Auto-categorization</div>
            </div>
            <div className="group bg-white/10 backdrop-blur-sm rounded-2xl p-4 border-2 border-white/20 hover:bg-white/20 transition-all cursor-pointer hover:scale-105">
              <div className="text-3xl font-bold text-white mb-1 group-hover:scale-110 transition-transform">Visual</div>
              <div className="text-white/80">Rich analytics</div>
            </div>
          </div>
        </div>

        <div className="relative z-10 text-white/60 text-sm">
          © 2025 Budgetly. Your finances, crystallized.
        </div>
      </div>

      {/* Right Panel - Form (Blended with gradient) */}
        ...
        <div className="w-full max-w-md space-y-8">
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-muted-foreground">Join Budgetly and take control of your finances</p>
            </div>
